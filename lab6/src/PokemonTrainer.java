...
public class PokemonTrainer extends JFrame{
    ...
    public void createSceneGraph(SimpleUniverse su){
        ...
        setToMyDefaultAppearance(bodyApp, new Color3f(.5f, .3f, .6f));
        ...
        setToMyDefaultAppearance(ballApp, new Color3f(0.2f, 0.9f, 0.5f));
        ...
        setToMyDefaultAppearance(secondBallApp, new Color3f(0.7f, 0.4f, 0.1f));
        ...
        setToMyDefaultAppearance(headApp, new Color3f(0.4f, 0.32f, 0.99f));
        ...
        setToMyDefaultAppearance(faceApp, new Color3f(0.68f, 0.45f, 0.53f));
